...
def main() :
    ...
    def copy_file(from_path, to_path) :
        ...
        string = string.replace('template_modulelib', "imgLP")
        string = string.replace('template_modulelowerlib', "imglp")
        string = string.replace('template_moduleequals', "="*len(name))
        string = string.replace('template_modlibeq', "="*len("imgLP"))
    ...
    modjson['date'] = date
    json_path = path.parent / f'libsLP/imgLP/src/imglp/modules.json'
    ...
    allmodules_path = path.parent / f'libsLP/imgLP/docs/source/modules.rst'
